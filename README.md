...
Generation) com **Claude (Anthropic)** e **Chroma** como banco vetorial.
...
> 💰 **Stack 100% gratuita**: embeddings locais, Chroma local, camada gratuita
> do Gemini (sem cartão de crédito) e OCI Compute dentro do *Always Free*
> (VM.Standard.E2.1.Micro, ou Ampere A1 até 2 OCPU/12GB). Nenhuma etapa deste
> projeto exige pagamento.
...
### 1. Pré-requisitos
- Python 3.11+
- Uma chave gratuita da API do Gemini, gerada em [aistudio.google.com/apikey](https://aistudio.google.com/apikey) (não pede cartão de crédito)
...
├── rag_chain.py              # Pipeline RAG: busca, prompt, chamada ao Claude, fallback
